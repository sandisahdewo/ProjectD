...
const finishInputDetail = (id) => Get(`pitstop-sarana/finish-input-detail/${id}`)
...
const exportPDF = (id, title) => GetBlob(`pitstop-sarana/export-pdf/${id}`, {
  path: dirs.DocumentDir,
  addAndroidDownloads : {
    useDownloadManager : true,
    notification : true,
    title: title,
    path: dirs.DownloadDir,
    description : 'Laporan PDF Pitstop Sarana'
  }
})
